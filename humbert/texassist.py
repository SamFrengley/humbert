...
This module contains some simple helper functions which allow us to write,
compile, and work with .tex files in the context of generating figures
depicting the intersections near the cusps.
