...
This module contains all the "elementary" formulae which we need to compute
invariants.
...
- kronecker(n, p)
- possible_r(N)
- HJ_continued_fraction(n, q)
- s_21(N, r)
- s_31(N, r)
- s_32(N, r)
- rho(N, r)

There are also many other functions which are required to compute the formulae
in Kani--Schanz.
